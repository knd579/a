...
question_turn = "player1"; //variavel vai guardar quem pergunta
answer_turn = "player2"; // variavel vai guardar   quem responde

function check() {

    get_answer = document.getElementById("input_check_box").value;
    //buscar valor da cisa e guardar na variavel get_answer
    answer = get_answer.toLowerCase();
    //deicha em letra minuscula
